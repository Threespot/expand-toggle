...
test("Start expanded test", () => {
  ...
  assert.equal(
    minify(document.body.innerHTML),
    minify(`
      <button type="button" data-expands="menu" data-expanded="" aria-controls="menu" aria-expanded="true">Toggle Menu</button>
      <div class="expandable" id="menu" aria-hidden="false">
        <p>Menu content</p>
      </div>`)
  );
...
test("Start expanded applies classes and active text", () => {
  ...
  assert.equal(
    minify(document.body.innerHTML),
    minify(`
      <button type="button" data-expands="menu" data-expanded="" data-expands-class="is-expanded" aria-controls="menu" aria-expanded="true" class="is-expanded">
...
test("Link with data attrs test", () => {
  ...
  assert.equal(
    ...
    minify(`
      <div>
        <a href="#" data-expands="menu" data-expands-class="is-expanded foo" data-expands-height="" aria-controls="menu" aria-expanded="true" role="button" class="is-expanded foo">
          <span data-expands-text="Close">Close</span>
        </a>
  ...
  assert.equal(
    ...
    minify(`
      <div>
        <a href="#" data-expands="menu" data-expands-class="is-expanded foo" data-expands-height="" aria-controls="menu" aria-expanded="false" role="button" class="">
          <span data-expands-text="Close">Toggle Menu</span>
        </a>
        <div class="expandable" id="menu" aria-hidden="true">
          <p>Menu content</p>
...
test("JS options test", () => {
  ...
  assert.equal(
    ...
    minify(`
      <div>
        <button type="button" data-expands="menu" aria-controls="menu" aria-expanded="true" class="is-expanded">
  ...
  assert.equal(
    ...
    minify(`
      <div>
        <button type="button" data-expands="menu" aria-controls="menu" aria-expanded="false" class="">
          <span data-expands-text="">Toggle Menu</span>
        </button>
        <div class="expandable" id="menu" aria-hidden="true">
          <p>Menu content</p>
...
test("ariaHasPopup option opts into aria-haspopup", () => {
  document.body.innerHTML = `
    <button type="button" data-expands="menu">Toggle</button>
    <div class="expandable" id="menu"><p>x</p></div>`;
  const toggle = document.querySelector("[data-expands]");
  new ExpandToggle(toggle, { ariaHasPopup: "menu" });
  assert.equal(toggle.getAttribute("aria-haspopup"), "menu");
});

test("data-expands-haspopup opts into aria-haspopup", () => {
  document.body.innerHTML = `
    <button type="button" data-expands="menu" data-expands-haspopup="dialog">Toggle</button>
    <div class="expandable" id="menu"><p>x</p></div>`;
  const toggle = document.querySelector("[data-expands]");
  new ExpandToggle(toggle);
...
test("aria-haspopup is omitted by default", () => {
  document.body.innerHTML = `
    <button type="button" data-expands="menu">Toggle</button>
    <div class="expandable" id="menu"><p>x</p></div>`;
  const toggle = document.querySelector("[data-expands]");
  new ExpandToggle(toggle);
  assert.equal(toggle.hasAttribute("aria-haspopup"), false);
});
